      ...
      {mode && !recipe && !loadingRecipe && (
        <>
          ...
          <div className="mb-5 flex items-center gap-2">
            ...
            <h1 className="font-display text-3xl font-extrabold tracking-tight text-ink">{mode.id}</h1>
          </div>
          ...
          <div className="space-y-3">
            {ideas.map((r, i) => (
              <button
                ...
                className="w-full rounded-2xl border border-hair bg-paper p-4 text-left transition hover:border-ink"
              >
      ...
      {recipe && !loadingRecipe && (
        <>
          ...
          <button
            ...
            className="mt-7 flex w-full items-center justify-center gap-2 rounded-xl bg-ink px-4 py-3.5 text-sm font-semibold text-white transition hover:bg-black"
          >
