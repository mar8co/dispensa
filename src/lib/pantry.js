...
const CATEGORY_KEYWORDS = {
  "Verdura": [
    ...
    // agrumi che l'utente tiene tra le verdure (uso da cucina/aromatico)
    "limone", "limoni", "lime", "limetta", "limette",
  ],
  "Frutta": [
    "arancia", "arance", "mela", "mele", "banana", "banane",
